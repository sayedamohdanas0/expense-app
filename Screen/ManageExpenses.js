...
function ManageExpenses({route,navigation}) {
    ...
    const selectedExpnses=expensesCtx.expenses.find((expense)=>expense.id===editedExpenseId)
    useLayoutEffect(()=>{
    ...
    return <View style={style.container}>
      <ExpenseForm defaultValue={selectedExpnses}  onsubmit={confirmHandler} submitButtonLable={isEditing ? 'Update':'Add'} onCancle={cancleHandler}/>
